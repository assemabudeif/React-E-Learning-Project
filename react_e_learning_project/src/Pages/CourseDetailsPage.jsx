...
import AlertDialog from "../Components/AlertDialogComp";
...
const CourseDetailsPage = () => {
  ...
  const HandleUnenrollCourse = () => {
    const enrolledCourses =
      JSON.parse(localStorage.getItem("enrolledCourses")) || [];
    let newEnrolledCourses = enrolledCourses.filter(
  ...
  return (
    <Container sx={{ py: 5 }}>
      ...
      <AlertDialog
        content={t("course.dialogContent")}
        title={t("course.dialogTitle")}
        openDialog={openDialog}
        handleCloseDialog={handleCloseDialog}
        confirm={HandleUnenrollCourse}
      />
    </Container>
  );
};
