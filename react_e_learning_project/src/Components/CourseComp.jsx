...
function CourseComp(props) {
  ...
  const ToggleFavorites = (e) => {
    ...
    if (isFavorite) {
      setIsFavorite(false);
      let newFavorite = favorites.filter(
  ...
  return (
    <>
        ...
        <CardContent>
          <Typography variant="h6" component="div">
            {props.course.name.length > 12
              ? `${
                  i18n.language === "en"
                    ? props.course.name.substring(0, 12)
                    : props.course.nameAr.substring(0, 12)
                }...`
              : i18n.language === "en"
              ? props.course.name
              : props.course.nameAr}
      ...
      <AlertDialog
        content={t("wishlist.dialogContent")}
        title={t("wishlist.dialogTitle")}
