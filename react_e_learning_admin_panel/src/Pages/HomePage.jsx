...
function HomePage() {
  ...
  const limit = 12;
  const [priceValueValidation, setPriceValueValidation] = useState(false);
  const [priceTypeValidation, setPriceTypeValidation] = useState(false);
  ...
  useEffect(() => {
    setPriceValueValidation(
      minPrice.length != 0 &&
        maxPrice.length != 0 &&
        Number(minPrice) > Number(maxPrice)
    );

    setPriceTypeValidation(
  ...
  return (
    <>
      ...
      <Typography
        variant={"h6"}
        sx={{ textAlign: "center", fontSize: "4vh", margin: "2vh" }}
      >
        {t("home.courses")}
      </Typography>
      {loading ? (
        ...
        <>
          {courses.length === 0 ? (
            <Typography
              variant={"h6"}
              sx={{ textAlign: "center", fontSize: "2vh", margin: "2vh" }}
            >
              {t("home.noCourses")}
            </Typography>
          ) : (
